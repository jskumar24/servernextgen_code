...
<body>
    ...
    <main>
        <div class="container-header-banner ">  
            ...
            <div class="row"> 
                <p class="container-header-banner-h1">Refund and Cancellation Policy</p>
        ...
        <div class="container py-3 my-sm-4">
            <div class="row">
                ...
                <p class="py-2 text-justify">We make an effort to offer top-notch services that satisfy your business needs.</p>
                <ul class="px-5"> 
