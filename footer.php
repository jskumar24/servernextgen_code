    ...
    <div class="container py-3">
      <footer>
        <div class="row col-6-f">
          ...
          <div class="col-6-f col-md-3 mb-3 px-xl-6">
            ...
            <ul class="nav flex-column">
              ...
              <li class="mb-2"><a href="terms.php" class="nav-link-footer hover-underline-animation">Terms &
                  Conditions</a>
              </li>
              <li class="mb-2"><a href="privacy.php" class="nav-link-footer hover-underline-animation">Privacy
                  policy</a>
              </li>
              <li class="mb-2"><a href="shipping.php" class="nav-link-footer hover-underline-animation">Shipping &
                  Delivery</a>
              </li>
              <li class="mb-2"><a href="refund.php" class="nav-link-footer hover-underline-animation">Refund &
                  Cancellations</a></li>
            </ul>
          </div>
          ...
          <div class="col-6-f col-md-2 mb-3 px-xl-6">
            ...
            <ul class="nav flex-column">
              <li class="mb-2"><a href="trading.php" class="nav-link-footer hover-underline-animation">Trading
                  Server</a>
              </li>
