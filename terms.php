...
<body>
    ...
    <main>
        <div class="container-header-banner ">
            ...
            <div class="row"> 
                <p class="container-header-banner-h1">Terms and Conditions</p>
        ...
        <div class="container py-3 my-sm-4">
            <div class="row">
                ...
                <hr>
                <p class="py-2 text-justify">Before using our services, consumers must read and accept the terms and conditions
                ...
                <ul class="px-5">
                    <li class="py-1 text-justify">Dedicated Hosting</li>
                    <li class="py-1 text-justify">VPS Hosting</li>
                    <li class="py-1 text-justify">Reseller Hosting</li>
                    <li class="py-1 text-justify">Shared Hosting</li>
                </ul>
                </p>
                <h5>Service Period</h5>
                <p class="py-2 text-justify">For a period of 12 months starting on the activation date, we offer hosting services to
                ...
                <p class="py-2 text-justify">For a period of two weeks, Servernexgen will keep a backup of the Managed Hosting
                ...
                <p class="py-2 text-justify">The Servernexgen has complied with the terms of the Agreement and the Acceptable Use
                ...
                <p class="py-2 text-justify">The use of bandwidth is not limited to shared hosting. Resellers, dedicated servers, and
                ...
                <p class="py-2 text-justify">The user may obtain a monthly credit to their account if any shared or reseller server
                ...
                <p class="py-1 text-justify">Users can send an email to support@Servernexgen.com to submit a ticket and provide our
                ...
                <p class="py-2 text-justify">As stated in the Service Level Agreement, we will do everything possible to have your
                ...
                <p class="py-2 text-justify">Unless both parties agree to it in advance, provide maintenance and support for
                    applications that are unrelated to Servernexgen.</p>

                <p class="py-1 text-justify">Unless we have a separate agreement with you, we will: Recover any Non-Servernexgen
                ...
                <p class="py-2 text-justify">What we have to do for clients without root or admin access.
                <ul class="px-5">
                    <li class="py-1 text-justify">
                ...
                <h5>Security</h5>
                <p class="py-2 text-justify">Users who violate or escalate network security privileges are subject to both criminal
                    and civil penalties. </p>
                <p class="py-1 text-justify">Security violations include things like gaining unauthorised access, scanning
                ...
                <h5>Cancellations</h5>
                <p class="py-2 text-justify">At least two weeks prior to the end of the current month, the user who wishes to
                ...
                <p class="py-2 text-justify">All of our company’s inactive services that are no longer operating will end immediately
                    and without prior warning. The subsequent repercussions are not our responsibility.</p>
                <h5>Refund Procedure</h5>
                <p class="py-2 text-justify">We make an effort to offer top-notch services that satisfy your business needs.
                <ul class="px-5">
                    <li class="py-1 text-justify">If the customer is not satisfied with our services, we offer a refund if customer
                        initiate the
                    ...
                    <li class="py-1 text-justify">If you paid with a credit card, we will refund the money to that card using the
                        information you
                    ...
                    <li class="py-1 text-justify">The only people who are eligible for a refund are new account holders. For
                    ...
                    <li class="py-1 text-justify">The administrative and installation costs associated with purchased software or
                        domain names are
                    ...
                    <li class="py-1 text-justify">There is no refund for taxes that were paid on the software or service. Users can,
                        however,
                        request their government to pay their taxes in full.</li>
                    <li class="py-1 text-justify">Users that use the servernexgen.com trial services are not eligible to receive
                        claims.</li>
                    <li class="py-1 text-justify">When users’ services are hindered or prevented from conducting illegal operations
                        like spam,
                        torrents, child porn, etc. on their websites, they are unable to make claims.</li>
                    <li class="py-1 text-justify">Refund requests can be made by users either online through our ticketing system or
                        by email.
                ...
                <h5>Privacy</h5>
                <p class="py-2 text-justify">Servernexgen makes care to protect the customer data that was gathered. Any changes made
                    to the page will be noted here and you’ll receive an email confirming them.</p>
                <h5>Client Access</h5>
                <p class="py-2 text-justify">Users are not given root or administrative access to the managed hosting server, in
                ...
                <p class="py-1 text-justify">You are permitted to deploy and administer programmes not provided by Servernexgen if
                    you request
                ...
                <h5>Our Rights</h5>
                <p class="py-2 text-justify">Managed hosting service locations are subject to change. We would let you know if there
