        ...
        <div class="carousel-item">
          ...
          <div class="carousel-caption">
            <div class="container px-0 py-0">
              <!-- <div class="card-car">
                <div class="card-body-car px-0"> -->
                <!-- <h3 class="container-banner-h3 card-title-car text-left f-6 f-color-car animated-text-zin">Share Hosting</h3>   -->
                <h3 class="container-banner-h3 ">Share Hosting</h3>
                  <!-- <p class="container-banner-p card-text-car text-left f-color-car animated-text-sin" style="text-wrap: wrap;">Secure and
                    scalable dedicated
                    server hosting
                    to drive your Online success for a low price.</p> -->
                    <p class="container-banner-p animated-text-sin" style="text-wrap: wrap;">Secure and
                    scalable dedicated
                    server hosting
                    to drive your Online success for a low price.</p>
                    <button class="container-banner-b button-car animated-text-zin"> More Details</button>
                <!-- </div>
              </div> -->
              <!-- <div class="container "><button class="container-banner-b button-car animated-text-zin"> More Details</button></div> -->
            </div>
          </div>
        </div>
        <div class="carousel-item">
          ...
          <div class="carousel-caption">
            <div class="container px-0 py-0">
              <!-- <div class="card-car">
                <div class="card-body-car px-0"> -->
                  <h3 class="container-banner-h3-v animated-text-zin">VPS</h3>
                  <p class="container-banner-p animated-text-sin" style="text-wrap: wrap;">Secure and
                    scalable dedicated
                    server hosting
                    to drive your Online success for a low price.</p>
                  <!-- <p class="container-banner-p" style="text-wrap: wrap;">Our expertise is scalable and easily upgradeable</p> -->
                    <button class="container-banner-b button-car animated-text-zin"> More Details</button>
                <!-- </div>
              </div> -->
              <!-- <div class="container"><button class="button-car  "> More Details</button></div> -->
